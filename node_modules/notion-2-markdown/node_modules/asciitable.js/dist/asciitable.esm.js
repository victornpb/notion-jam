...
function matrixToAsciiTable(m, options) {
  ...
  var colsWidth = calcColumnsWidth(m); // create table
  ...
  for (var r = 0, rLen = m.length; r < rLen; r++) {
    ...
    if (m[r]) {
      ...
      for (var _c = 0; _c < colsWidth.length; _c++) {
        cols.push(repeatStr(colsWidth[_c] + paddingLength, options.hr.str));
      }
...
export { matrixToAsciiTable as default };
//# sourceMappingURL=asciitable.esm.js.map
